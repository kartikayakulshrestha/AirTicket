...
function App() {
  ...
  async function handleSubmit() {
    let ori = orginAirport.filter((x) => {
      return x == s;
    });
    let dest = destinationAirport.filter((x) => {
      return x == d;
    });
    let cab = cabin.filter((x) => {
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-10 sm:col-span-6  xl:col-span-4 ">
            ...
            <div className="bg-[#181818] ml-2 mb-8 h-16 w-64 hover:bg-[#1c2519]">
              <div
                className={`flex py-5 ${
                  cabinOptions == "hidden" ? "" : "hidden"
                } ${destinationOptions == "hidden" ? "" : "hidden"}`}
              >
                <div className="mx-5">
                  <button
                    className={` ${
                      toggle == 0 ? "bg-slate-600" : "bg-orange-700"
                    } my-1 h-4 w-8 rounded-lg relative`}
                    onClick={() => {
                      toggle == 0 ? settoggle(1) : settoggle(0);
                    }}
                  >
                    <div
                      className={` h-4 w-4 absolute top-0 rounded-full ${
                        toggle == 0
                ...
                <p
                  className={`${
                    toggle == 0 ? "text-[#5e5e5e]" : "text-[#e8e4e4]"
                  }`}
                >
                  Show{" "}
                  <span
                    className={`${
                      toggle == 0 ? "text-[#834218]" : "text-orange-500"
                    }`}
                  >
                    Pro Filters
                  </span>
            ...
            <button
              className="bg-[#38b8a6] mb-10 text-white py-2 px-6 rounded-md"
                          ...
                          <div key={index}>
                            <div className="bg-[#346c4a] col-span-1 h-[350px] rounded-lg">
                              <div className="grid text-white justify-center">
                                ...
                                ></img>
                                <h3 className="text-2xl my-1 font-normal text-center">
                                  {dataa.partner_program}
                                </h3>
